...
class VideoKhoaHocController extends Controller
{
    ...
    public function courseVideo($slug)
    {
        ...
        // $comment_cc = AnswerToTeacher::whereNull('asw_parent')->with('get_child_cate')->get();
        // $comment_cc = AnswerToTeacher::whereNull('asw_parent')->with('childAnswer')->get();
        // $comment_cc = AnswerToTeacher::with('childAnswer')->get();
        $comment_cc_not_null = AnswerToTeacher::whereNotNull('asw_parent')->with('childAnswer')->get();
        // $comment_cc = AnswerToTeacher::where('asw_id_user','=',get_data_user('web'))->where('asw_id_course',$id_course)->get();
