            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown nav-item main-header-message ">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="main-message-list chat-scroll">
                            <a href="empty#" class="p-3 d-flex border-bottom">
                                <div class="  drop-img  cover-image  " data-image-src="https://laravel.spruko.com/valex/leftmenu-light-ltr/assets/img/faces/3.jpg">
                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="main-notification-list Notification-scroll">
                            <a class="d-flex p-3 border-bottom" href="empty#">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="empty"><i class="bx bx-user-circle"></i>Profile</a>
