                                    ...
                                    @foreach ($transactions as $item)
                                        ...
                                        <tr>
                                            <td scope="row" style="position:relative;" data-tooltip="Click để xem chi tiết"
                                                class="css-tooltip">
                                                <a data-pjax href="{{ route('get.video.kh',App\Models\Cart\Order::find($item->o_action_id)->course->c_slug) }}">DH{{ $item->id }}</a>
                                            </td>
                                            <td>
                                            ...
                                            <td> 
                                                ...
                                                <td>
                                                    <a href="{{ route('get.video.kh',App\Models\Cart\Order::find($item->o_action_id)->course->c_slug) }}"
                                                        class="btn btn-xs label-info"><i class="fa fa-eye"></i></a>
                                                </td>
