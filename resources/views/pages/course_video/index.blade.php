...
<div class="page-content">
    ...
    <div class="box-comment">
        <div class="contaner">
            <form class="form-horizontal" autocomplete="off" action="{{ route('get.video.kh',$courseDetail[0]->c_slug) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <button type="submit" class="btn btn-answer">Gửi câu hỏi</button>
            </form>
        </div>
    </div>
    <div class="box-comment">
