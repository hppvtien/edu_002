...
/* harmony import */ var _helpers_function__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../helpers/function */ "./resources/assets/helpers/function.js");
...
var Auth = {
  ...
  handleLoginGoogle: function handleLoginGoogle() {
    var login = Object(_helpers_function__WEBPACK_IMPORTED_MODULE_2__["login_google"])('js_login_google');
    console.log(login);
  ...
  changeFormAuth: function changeFormAuth() {
      ...
      $.ajax({
        ...
        success: function success(results) {
          if (results.status === 404) {
            toastr__WEBPACK_IMPORTED_MODULE_1___default.a.error(results.message);
            return false;
          }
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var jquery_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery-modal */ "./node_modules/jquery-modal/jquery.modal.js");
/* harmony import */ var jquery_modal__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery_modal__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _inc_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_inc_auth */ "./resources/assets/components/_inc_auth.js");
/* harmony import */ var _inc_run_message__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./_inc_run_message */ "./resources/assets/components/_inc_run_message.js");
/* harmony import */ var _inc_search__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./_inc_search */ "./resources/assets/components/_inc_search.js");
      ...
      if (URL) {
        ...
        $.ajax({
          beforeSend: function beforeSend(xhr) {
            $this.html("<i class=\"fa fa-spinner fa-spin\"></i> \u0110ang x\u1EED l\xFD");
          },
          url: URL,
          method: "POST",
          data: {
  ...
  buyNow: function buyNow() {
    ...
    $(".js-buy-now").click(function (event) {
      ...
      if (typeof URL !== "undefined") {
        var result = _this.processAddCart(URL, $this);
    ...
    $(".js-add-cart").click(function (event) {
      ...
      if (typeof URL !== "undefined") {
        ...
        result.done(function (results) {
          ...
          if (results.status === 200) {
            var $count = $("#countSource");
            var numberCount = $count.text();
...
/***/ "./resources/assets/components/_inc_multiple_choice.js":
/*!*************************************************************!*\
  !*** ./resources/assets/components/_inc_multiple_choice.js ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _helpers_browser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/browser */ "./resources/assets/helpers/browser.js");
...
var MultipleChoice = {
  ...
  startTimeChoice: function startTimeChoice() {
    var _this = this;
  ...
  countDown: function countDown() {
    ...
    var $formSubmit = $("#myForm");
    var $timer = $("#timer");

    if ($timer.length) {
      if (_helpers_browser__WEBPACK_IMPORTED_MODULE_0__["default"].checkCookie(_this.nameCookieChoice)) {
        _this.countTime = _helpers_browser__WEBPACK_IMPORTED_MODULE_0__["default"].getCookie(_this.nameCookieChoice);
      } else {
        _helpers_browser__WEBPACK_IMPORTED_MODULE_0__["default"].setCookie(_this.nameCookieChoice, _this.countTime);
      }
      ...
      if (_this.countTime > 0) {
        ...
        $timer.html("<i class=\"fa fa-clock-o\" aria-hidden=\"true\"></i>  <b>".concat(_this.secondsToHms(_this.countTime), "</b> gi\xE2y "));
        ...
        if ($formSubmit.length) {
          $formSubmit.submit();
          _helpers_browser__WEBPACK_IMPORTED_MODULE_0__["default"].setCookie(_this.nameCookieChoice, null);
        }
      }
    }
  },
...
/***/ "./resources/assets/components/_inc_search.js":
/*!****************************************************!*\
  !*** ./resources/assets/components/_inc_search.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var typeahead_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! typeahead.js */ "./node_modules/typeahead.js/dist/typeahead.bundle.js");
...
/* harmony import */ var bloodhound_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! bloodhound-js */ "./node_modules/bloodhound-js/index.js");
/* harmony import */ var bloodhound_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(bloodhound_js__WEBPACK_IMPORTED_MODULE_1__);
...
var SearchGuest = {
  ...
  searchUser: function searchUser() {
    var $element = $("#input_search");
    var bloodhound = new bloodhound_js__WEBPACK_IMPORTED_MODULE_1___default.a({
      datumTokenizer: bloodhound_js__WEBPACK_IMPORTED_MODULE_1___default.a.tokenizers.whitespace,
      queryTokenizer: bloodhound_js__WEBPACK_IMPORTED_MODULE_1___default.a.tokenizers.whitespace,
      remote: {
    ...
    $element.typeahead({
      ...
      templates: {
        empty: ['<div class="list-group search-results-dropdown">' + '<div class="list-group-item">Không tồn tại dữ liệu.</div>' + '</div>'],
...
/* harmony default export */ __webpack_exports__["default"] = (SearchGuest);
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))

/***/ }),

/***/ "./resources/assets/helpers/browser.js":
/*!*********************************************!*\
  !*** ./resources/assets/helpers/browser.js ***!
  \*********************************************/
/*! exports provided: default */
...
var Browser = {
  setCookie: function setCookie(cname, cvalue) {
    var minutes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    var d = new Date();
  ...
  checkCookie: function checkCookie(cname) {
    var username = Browser.getCookie(cname);
    return username ? 1 : 0;
  },
...
/***/ "./resources/assets/helpers/function.js":
/*!**********************************************!*\
  !*** ./resources/assets/helpers/function.js ***!
  \**********************************************/
/*! exports provided: to_slug, login_google, login_or_register */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "to_slug", function() { return to_slug; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "login_google", function() { return login_google; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "login_or_register", function() { return login_or_register; });
/* harmony import */ var _plugins_jquery_login_google__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../plugins/jquery.login.google */ "./resources/assets/plugins/jquery.login.google.js");
/* harmony import */ var _plugins_jquery_login_google__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_plugins_jquery_login_google__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _js_config_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../js/config/service */ "./resources/assets/js/config/service.js");
...
function login_google(element) {
  return $(document.getElementById(element)).login_google({
    appID: _js_config_service__WEBPACK_IMPORTED_MODULE_1__["default"].google.client_id
  });
}
...
/***/ "./resources/assets/js/config/service.js":
/*!***********************************************!*\
  !*** ./resources/assets/js/config/service.js ***!
  \***********************************************/
/*! exports provided: default */
...
var Service = {
  google: {
    client_id: '264409137001-t3k59t8fsgsie5pqag2to9emp9cion5i.apps.googleusercontent.com'
  },
  facebook: {
    id: '247776569326612',
    permissions: 'email',
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! toastr */ "./node_modules/toastr/toastr.js");
/* harmony import */ var toastr__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(toastr__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_inc_cart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../components/_inc_cart */ "./resources/assets/components/_inc_cart.js");
/* harmony import */ var _components_inc_autoload__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../components/_inc_autoload */ "./resources/assets/components/_inc_autoload.js");
/* harmony import */ var _components_inc_multiple_choice__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../components/_inc_multiple_choice */ "./resources/assets/components/_inc_multiple_choice.js");
...
var Course = {
  ...
  showPopupViewCourse: function showPopupViewCourse() {
    $(".js-view-course").click(function (event) {
      event.preventDefault();
      var $this = $(this);
      var URL = $this.attr('href');
      $.ajax({
        beforeSend: function beforeSend(xhr) {// $this.html(`<i class="fa fa-spinner fa-spin"></i> Đang xử lý`)
        },
        url: URL,
        method: "GET",
        success: function success(results) {
          if (results.status === 404 || results.code === 401) {
            toastr__WEBPACK_IMPORTED_MODULE_0___default.a.warning(results.message);
            return false;
          }

          $("#video-responsive").html(results.html);
          toastr__WEBPACK_IMPORTED_MODULE_0___default.a.success(results.message); // Toastr.warning(results.message)
        },
        error: function error(results) {
          console.log(results);
        }
  ...
  showPopupViewComment: function showPopupViewComment() {
  ...
  addFavourites: function addFavourites() {
    var _this = this;
    ...
    $(".js-save-favorite").click(function (event) {
      ...
      _this.flagClick = true;
      var URL = $this.attr('data-url');
	  var count_fav = parseInt($('#count_favourites').text());
      ...
      if (URL) {
        ...
        $.ajax({
          ...
          success: function success(results) {
            ...
            if (results.status === 200) {
				$('#count_favourites').html(count_fav + 1);
              toastr__WEBPACK_IMPORTED_MODULE_0___default.a.success("Thêm yêu thích thành công");
            }
          },
          error: function error(results) {
            $this.html(htmlOld);
...
$(function () {
  Course.init();
  _components_inc_cart__WEBPACK_IMPORTED_MODULE_1__["default"].init();
  _components_inc_autoload__WEBPACK_IMPORTED_MODULE_2__["default"].init();
  _components_inc_multiple_choice__WEBPACK_IMPORTED_MODULE_3__["default"].init();
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))

/***/ }),

/***/ "./resources/assets/plugins/jquery.login.google.js":
/*!*********************************************************!*\
  !*** ./resources/assets/plugins/jquery.login.google.js ***!
  \*********************************************************/
/*! no static exports found */
...
/* WEBPACK VAR INJECTION */(function(jQuery, $) {(function () {
  ...
  var LoginGoogle = {
        ...
        window.gapi.load('auth2', function () {
          if (!window.gapi.auth2.getAuthInstance()) {
            gapi.load('auth2', function () {
              ...
              var element = document.getElementById($(_this.settings.element).attr('id'));
    ...
    loadScript: function loadScript(d, s, id, jsSrc, cb) {
    ...
    initAppGoogle: function initAppGoogle() {
      var _this = this;
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\edu\resources\assets\js\pages\course\course.js */"./resources/assets/js/pages/course/course.js");
